...
define(function(require, exports, module) {
    ...
    var uiUtils = require('../../ui/uiutils');
    var UIBase = require('../../ui/uibase');
    var UI = require('../../ui/ui'); // 提供baidu.editor.ui命名空间
    ...
    (function(){
        ...
        function convert_url(url){
            ...
            url = utils.trim(url)
                ...
                .replace(/www\.tudou\.com\/(?:listplay|albumplay)\/([\w\-]+)\/([\w\-]+)/i, "www.tudou.com/v/$2/lianyue.swf")
