module.exports = function (grunt) {
                ...
                files: [
                    {
                        expand: true,
                        cwd: '.build/app',
                        src: ['**/index.js', '**/*.entry.js'],
                        dest: staticFolderName + '/js/' + distFolder + '/app'
                    }
                ]
            },
            helper: {
                ...
                files: [
                    {
                        src: ['.build/app/common/helper.js'],
                        dest: staticFolderName + '/js/' + distFolder + '/app/common/helper.js'
                    }
                ]
            },
            phelper: {
                ...
                files: [
                    {
                        src: ['.build/app/common/push_helper.js'],
                        dest: staticFolderName + '/js/' + distFolder + '/app/common/push_helper.js'
                    }
                ]
            }
        },
        ...
        uglify: {
            app: {
                files: [
                    {
                        expand: true,
                        cwd: staticFolderName + '/js/' + distFolder + '/',
                        src: ['**/*.js', '!lib/**/*.js'],
                        dest: staticFolderName + '/js/' + distFolder + '/',
    ...
    grunt.registerTask('default', ['transport:app', 'concat', 'uglify:app', 'clean']);
